...
namespace Kizami.Voxel.DebugTools
{
    ...
    public sealed class VoxelDebugCarveTool : MonoBehaviour
    {
        ...
        private VoxelObject _statsTarget;
        private float _yaw;
        ...
        private void Start()
        {
            ...
            _statsTarget = FindAnyObjectByType<VoxelObject>();
        ...
        private void Update()
        {
            ...
            var target = hit.collider.GetComponentInParent<VoxelObject>();
        ...
        private void Edit(VoxelObject target, Vector3 worldPoint, VoxelCsgOperation operation)
        {
            ...
            switch (_shape)
            {
                case ToolShape.Sphere:
                    target.ApplyEdit(new SphereShape(center, radius), operation);
                    break;
